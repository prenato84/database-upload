# bootcamp-gostack-desafio-6

Desafio 6 do Bootcamp GoStack 11
...
Nesse desafio foi dada continuidade à aplicação de gestão de transações para continuar treinando o que aprendi até agora no Node.js junto ao TypeScript, mas dessa vez incluindo o uso de banco de dados com o TypeORM e envio de arquivos com o Multer!

O SGBD utilizado foi o PostgreSQL rodando num container do Docker.

É uma aplicação que armazena transações financeiras de entrada e saída e permiti o cadastro e a listagem dessas transações, além de permitir a criação de novos registros no banco de dados a partir do envio de um arquivo csv.
...
```
> git clone https://github.com/prenato84/database-upload
```
